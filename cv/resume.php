<?php
  ...
  if(isset($_GET['id']) and ctype_digit($_GET['id']))
  {
      $id=$_GET['id'];
        ...
        $sql=sprintf("SELECT * FROM user u,competence c,loisir l ,formation f,experience e WHERE u.id=$id and c.user_id =$id and  l.user_id=$id and f.user_id =$id and e.user_id =$id  ") or die(mysqli_error($db));
        $result=$db->query($sql);
  }    
    ...
    <div class="wrapper-mid">
      ...
      <div id="paper">
        ...
        <div id="paper-mid">
          <div class="entry">
            <!-- Begin Image -->
            <?php  echo '<img class="portrait" src="'.$row['photo'].'" alt="" /> ';  }?>
